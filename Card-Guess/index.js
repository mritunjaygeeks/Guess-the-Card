let cards = [
  ...
  {
    image:
      "https://i.pinimg.com/originals/7c/70/3f/7c703ff95934b0094c5be9994f1998c5.jpg",
    value: 2,
    status: "closed",
  },
  {
  ...
  {
    image:
      "https://r1.ilikewallpaper.net/iphone-8-wallpapers/download/111121/Baby-Groot-Profile-HD-Tip-iphone-8-wallpaper-ilikewallpaper_com_750.jpg",
    value: 5,
    status: "closed",
  },
  {
...
function openCard(index) {
  ...
  if (cardCount === 1) {
    ...
    if (val1 === val2) {
      ...
      let gOver = document.getElementById("g-over");
